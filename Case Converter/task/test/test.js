...
const pagePath =
  "file://" + path.resolve(__dirname, workingDir + "/index.html");
  ...
  tests = [
    ...
    this.node.execute(() => {
      ...
      if (!fs.existsSync(filePath)) {
        return wrong(
          "Looks like you didn't download a text file named 'text.txt', after clicking on 'Save Text File' button",
        );
      }
